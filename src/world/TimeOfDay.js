...
const KEYS = [
  ...
  { h: 6.4,  elev: 3,   azi: 84,  sun: 0xff9c52, si: 0.75, amb: 0x4b4a63, ai: 0.42, zen: 0x2d4f80, hor: 0xf0a468, fog: 0xc99a82 },
  { h: 8.0,  elev: 22,  azi: 100, sun: 0xffd9a8, si: 1.35, amb: 0x7f90a8, ai: 0.55, zen: 0x2f6cb4, hor: 0xc3dcee, fog: 0xb9d2e4 },
  { h: 12.5, elev: 68,  azi: 180, sun: 0xfff6e4, si: 1.75, amb: 0x9fb4c8, ai: 0.68, zen: 0x2467b8, hor: 0xbdd8ec, fog: 0xbdd6e8 },
  { h: 16.5, elev: 28,  azi: 250, sun: 0xffe2b0, si: 1.4,  amb: 0x8a9cb2, ai: 0.58, zen: 0x2b68ac, hor: 0xcbdcea, fog: 0xc0d2e0 },
  { h: 18.7, elev: 4,   azi: 272, sun: 0xff7a3c, si: 0.95, amb: 0x5d5570, ai: 0.44, zen: 0x2a4478, hor: 0xff9a55, fog: 0xd08f68 },
...
export class TimeOfDay {
  ...
  refresh() {
    ...
    this.ambient.groundColor.set(0x3b342a).lerp(s.ambColor, 0.4);
