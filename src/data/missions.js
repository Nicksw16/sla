...
export const MISSIONS = [
  // ---------------------------------------------------------------- LEARNING
  {
    ...
    route: [
      pt(0, 325, 900, 52), pt(-100, 335, 300, 52), pt(-150, 345, -300, 52),
      pt(0, 355, -900, 52), pt(350, 350, -1400, 52), pt(850, 340, -1700, 52),
    ],
    timeLimit: null,
    stars: { time: [50, 66, 92] },
  ...
  },
  {
    ...
    start: { x: 1293, y: 330, z: -105, heading: -2.74, speed: 68 },
    route: [
  ...
  },
  {
    ...
    start: { x: -700, y: 330, z: 1600, heading: 0.6, speed: 78 },
    route: line([-700, 335, 1600], [1500, 355, -1600], 7, 44),
    timeLimit: 90,
    stars: { time: [48, 60, 82] },
  ...
  },
  {
    ...
    start: { x: -3000, y: 265, z: 2400, heading: Math.PI, speed: 80 },
    route: [
      pt(-3000, 255, 3100, 46), pt(-2950, 250, 3900, 46), pt(-2700, 250, 4600, 46),
      pt(-2100, 258, 5050, 46), pt(-1300, 266, 5250, 46), pt(-400, 275, 5100, 46),
      pt(400, 285, 4650, 46),
    ],
    timeLimit: 95,
    stars: { time: [58, 70, 92] },
